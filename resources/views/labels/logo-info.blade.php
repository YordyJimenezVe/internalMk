...
<head>
    <meta charset="UTF-8">
    <title>Etiqueta Maikel Cars - Contacto</title>
    <style>
        * {
        ...
        /* Espacio en blanco completamente limpio para escribir a mano */
        .blank-write-space {
            width: 80mm;
            height: 14mm;
        }

        /* Columnas de información alineadas con la línea */
        .columns-container {
            width: 80mm;
            display: flex;
...
<body onload="window.print()">
    <div class="label-cell">
        ...
        <!-- Espacio completamente en blanco para escritura manual -->
        <div class="blank-write-space"></div>

        <!-- Información de Contacto en 2 Columnas alineadas -->
        <div class="columns-container">
            <!-- Columna Izquierda: Web & Instagram -->
            ...
            <!-- Columna Derecha: Teléfonos (WhatsApp) -->
