    ...
    <AuthenticationCard>
        ...
        <div class="mb-6 p-4 bg-rose-500/10 border border-rose-500/30 text-rose-400 rounded-xl text-left text-xs font-bold flex items-center gap-3">
            ...
            <div>
                ...
                <p class="text-gray-300 font-medium">La suscripción del plan de negocios para <span class="text-white font-bold">maikelcars.com</span> vencerá en 10 días. Por favor, realice el pago de renovación a la brevedad para evitar la suspensión del servicio.</p>
            </div>
        </div>
