                                ...
                                <tr v-for="factura in filteredFacturas" :key="factura.id" class="hover:bg-gray-50 dark:hover:bg-gray-900/40 transition-colors group">
                                    ...
                                    <td class="px-6 py-6 border-l border-gray-50 dark:border-gray-700/30">
                                        <div class="flex items-center justify-end gap-2.5">
                                            ...
                                            <button v-if="(factura.partidas || factura.partida || factura.inventario) && String((factura.partidas || factura.partida || factura.inventario).tipo || '').toUpperCase().includes('MOTOR')" @click="visualizeWarranty(factura.id)" class="p-2.5 rounded-xl bg-gray-50 dark:bg-gray-900/50 text-gray-500 dark:text-gray-400 hover:bg-white dark:hover:bg-gray-700 hover:text-amber-500 hover:shadow-xl hover:shadow-amber-500/20 transition-all transform hover:scale-110 active:scale-95" title="Póliza de Garantía">
