    ...
    <AppLayout title="Asignaciones">
        <template #header>
            <h1 v-if="props.bill && props.bill.fecha" class="text-center">
                Editar Factura {{ props.bill.numero_factura }} de fecha {{ props.bill.fecha }}
            </h1>
        </template>
        ...
        <div class="bg-white">
            <form ref="form" @submit.prevent="submitForm" class="w-full max-w-lg mx-auto" method="post">
                <div class="flex flex-wrap mx-3 mb-6">
                    ...
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="fecha" type="text" placeholder="Fecha" :value="props.bill.fecha">
                    </div>
                    <div class="w-full md:w-1/2 px-3">
                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="hora">
                        Hora
                    </label>
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="hora" type="text" placeholder="Hora" :value="props.bill.hora">
                    </div>
                </div>
                <div class="flex flex-wrap mx-3 mb-6">
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-red-500 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" name="big" type="text" placeholder="Big" :value="props.bill.big">
                    </div>
                    <div class="w-full md:w-1/2 px-3">
                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="Igtf">
                        Igtf
                    </label>
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="igtf" type="text" placeholder="Igtf" :value="props.bill.igtf" required>
                    </div>
                    <div class="w-full md:w-1/2 px-3">
                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="numero_factura">
                        Número Factura
                    </label>
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="numero_factura" type="text" placeholder="Número Factura" :value="props.bill.numero_factura" required>
                    </div>
                    <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="numero_control">
                        Número Control
                    </label>
                    <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" name="numero_control" type="text" placeholder="Número Control" :value="props.bill.numero_control" required>
                    </div>
                    <div class="w-full md:w-1/2 px-3">
...
export default {
  methods: {
    submitForm() {
        ...
        this.$inertia.post('/billing/update/' + this.bill.id, data);
    }
}
};
</script>